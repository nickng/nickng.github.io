//$ sessionjc -cp lib -d lib src/jacobi/mc/WorkerSouthWest.sj
//$ sessionj  -cp lib:lib/jyaml.jar jacobi.mc.WorkerSouthWest mesh.yaml southwest
...
//                printMatrixContent(matrix);
                ...
                System.err.println("[WorkerSouthWest] Non-dual behaviour: "+ise);

            } catch (SJIOException ioe) {

                System.err.println("[WorkerSouthWest] Communication error: "+ioe);

            } catch (ClassNotFoundException cnfe) {

                System.err.println("[WorkerSouthWest] Class not found: "+cnfe);
